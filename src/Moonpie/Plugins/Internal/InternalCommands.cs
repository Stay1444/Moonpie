...
public class InternalCommands : BaseCommandModule
{
    ...
    public async Task Moonpie(CommandContext ctx)
    {
        await ctx.Player.SendMessageLinesAsync(
            ChatComponent.From(ChatColor.Blue, "Moonpie"),
            ...
            ChatComponent.From(ChatColor.DarkGray, "| ", ChatColor.Gray, "More info: ", ChatColor.Aqua, "https://github.com/Stay1444/Moonpie")
        );
    }
}